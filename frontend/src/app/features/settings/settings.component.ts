  ...
  load() {
    ...
    this.service.getUpdateSettings().subscribe({
      next: r => {
        ...
        if (r.code === 200) {
          this.updateOptions.set(r.data.options || []);
